...
The idea behind the project is the increase traffic to the Fibromyalgia website.
...
This page will give a large text base about the illness and it will also give some quick tips and tricks.

About:

This page is to cover about the support group and who is running the website / charity.
It highlights the founding members and their experience with the illness.

Contat Page:

The contact page will have a basic contact form that in future releases will link to an email api.
It will also have links to the charities email, phone number, and current facebook group.
